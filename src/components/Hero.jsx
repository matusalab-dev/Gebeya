...
const Hero = () => {
  return (
    <section className="w-full grid grid-cols-[repeat(3,_1fr),_120px_1fr] grid-rows-9 gap-x-2  lg:grid-cols-10 h-[calc(100vh_-_5.79rem)] justify-between inverse full-bleed text-background md:pt-16 md:pb-8 py-10">
      <h1 className="relative col-start-1 col-span-1 row-start-1 row-span-1 self-start text-[clamp(1rem,_6vw_+_1rem,_8rem)] font-alfa ">
        Gebeya{" "}
        <span className="absolute uppercase top-[86%] lg:top-[87%] left-[calc(77vw_-_1.5rem)] md:left-[calc(56vw_-_1.5rem)] lg:left-[calc(60.7vw_-_1.5rem)] ">
          Shop
        </span>
      </h1>
